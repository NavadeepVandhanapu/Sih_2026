...
import { users, companies, products, scans, declarations, ruleEvaluations, complaints, companyResponses, governmentReviews, inspections, auditLogs, } from './schema.js';
export async function seed() {
    ...
    const companyData = [
        ...
        {
            id: 'comp-greenbasket',
            name: 'GreenBasket Consumer Products',
    ...
    const productData = [
        ...
        },
        {
            ...
            name: 'Pure Cold Pressed Sweet Almond Oil',
            brand: 'GreenBasket Botanicals',
            category: 'Cosmetics & Personal Care',
            barcode: '8902040056781',
            standardNetQuantity: '100 ml',
            standardMrp: '₹249.00',
            totalScans: 35,
        ...
        },
        {
            ...
            companyId: 'comp-nova',
            name: 'Lemon Power Liquid Dishwash',
            brand: 'Nova Clean',
            category: 'Household',
...
`.trim(),
    ...
    // Generate 48 additional diverse complaints for realistic analytics
    const statuses = [
        'SUBMITTED',
    ...
    for (let i = 1288; i <= 1335; i++) {
        ...
        db.insert(complaints)
            ...
            productId: 'prod-apex-biscuits',
            status: randomStatus,
            consumerNotes: `Automated consumer grievance regarding packaging declaration compliance. Reference index ${i}.`,
            consumerLocation: `Zone ${i % 5 + 1}, District ${i % 12 + 1}`,
            purchaseStore: 'Retail Commodity Mart',
            createdAt: dateStr,
            updatedAt: dateStr,
        })
            .onConflictDoNothing()
    ...
    db.insert(companyResponses)
        ...
        companyId: 'comp-apex',
        responseText: 'We acknowledge the consumer feedback regarding the consumer care contact details on batch APX-9824. While our corporate office address was printed on the seal fold, we have updated the artwork to place the 1800-tollfree and email directly on the primary display panel with 2.2 mm font height.',
    ...
    db.insert(governmentReviews)
        ...
        officerNotes: 'Physical verification at retail premise confirmed dual MRP sticker tampering violating Section 18 read with Rule 18(2) of Legal Metrology PC Rules. Compounding show-cause notice issued to manufacturer and distributor.',
