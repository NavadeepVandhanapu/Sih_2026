    ...
    static async generatePDF(data, outputPath) {
        return new Promise((resolve, reject) => {
            ...
            doc
                ...
                .font('Helvetica')
                .text('This document is an AI-assisted screening assessment generated under the DoCA Legal Metrology Enforcement Support System. ' +
                'Findings labeled "Potential Non-Compliance" do not constitute final judicial guilt. ' +
                'Final compoundings, seizures, and statutory penalties require human verification by an authorized Legal Metrology Inspector under the Legal Metrology Act, 2009.', 45, doc.page.height - 60, { width: 505 });
            doc.end();
