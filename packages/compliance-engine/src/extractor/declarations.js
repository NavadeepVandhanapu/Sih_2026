export class DeclarationExtractor {
    ...
    static extractPackerImporter(text) {
    ...
    static extractNetQuantity(text) {
    ...
    static extractConsumerCare(text) {
    ...
    static extractUnitSalePrice(text) {
    ...
    static extractCountryOfOrigin(text) {
