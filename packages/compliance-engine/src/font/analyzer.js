export class FontAnalyzer {
     ...
     */
    static getRequiredMinimumMm(netQtyString) {
        if (!netQtyString)
    ...
    static analyze(params) {
        ...
        let estimatedMm = 0;
        let method = 'estimated_dpi';
        let confidence = 0.72;
        if (params.packageHeightMm &&
            ...
            estimatedMm = parseFloat(((params.measuredCharHeightPx / params.imageHeightPx) * params.packageHeightMm).toFixed(2));
